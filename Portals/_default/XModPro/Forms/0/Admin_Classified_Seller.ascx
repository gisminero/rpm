...
<xmod:FormView runat="server"><AddItemTemplate><xmod:AddForm runat="server">
  ...
  <div class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <DropDownList Id="Seller_Level" CssClass="form-control" DataField="Seller_Level" DataSourceId="cds_Levels" DataTextField="Level_Name" DataValueField="LevelID" AppendDataBoundItems="true" DataType="int32">
          <ListItem Value="">- Please Select -</ListItem>
        </DropDownList>
