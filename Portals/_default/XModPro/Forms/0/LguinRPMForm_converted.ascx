...
<xmod:FormView runat="server"><AddItemTemplate><xmod:AddForm runat="server">
  ...
  <SubmitCommand CommandText="INSERT INTO [Users] ([Username], [Email]) VALUES(@Username, @Email) " /><div class="xmp-form xmp-LguinRPMForm">
    ...
    <div class="xmp-form-row"><Label CssClass="xmp-form-label NormalBold" For="Email">Email</Label><TextBox Id="Email" Width="250" MaxLength="100" DataField="Email" DataType="string"></TextBox>
  </div><ValidationSummary CssClass="NormalRed xmp-validation" Id="vsUsers"></ValidationSummary>
  <label for="uplMugShot" text="Mug Shot" /> 
        <FileUpload 
        id="uplMugShot" 
        path="~/Portals/nuevasinpermisos/Images/" 
        extensions="gif,jpg"
        datafield="UserImage" 
        datatype="string"
  ...
  <div class="xmp-form-row"><Label class="xmp-form-label NormalBold">&nbsp;</Label>
    <AddButton Text="Ingresar"></AddButton>
