...
<xmod:Template runat="server" UsePaging="True" Ajax="False" AddRoles="Editor" EditRoles="" DeleteRoles="" DetailRoles="">
  <ListDataSource CommandText="SELECT [id_provincia], [nombre_provincia], [cantidad_habitantes], [id_pais] FROM XMP_Provincias"/>
  <DetailDataSource CommandText="SELECT [id_provincia], [nombre_provincia], [cantidad_habitantes], [id_pais] FROM XMP_Provincias WHERE [id_provincia] = @id_provincia">
  ...
  <ItemTemplate>
      <div style="width:133px;float:left;margin:0px;">
        ...
        <span><%#Eval("Values")("id_pais")%></span><br />
        <div>
  ...
  <DetailTemplate>
    ...
    <strong>id_pais</strong> <%#Eval("Values")("id_pais")%><br />
    <xmod:ReturnLink runat="server" CssClass="dnnSecondaryAction" Text="&lt;&lt; Return" />

  </DetailTemplate>
</xmod:Template>
<div>
  <xmod:AddImage runat="server" Text="New" ImageUrl="~/images/eip_edit.png" />
  </div>
</xmod:masterview>